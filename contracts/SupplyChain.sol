...
contract SupplyChain {
    ...
    function addRMS(
        ...
        rmsCtr++;
        RMS[rmsCtr] = rawMaterialSupplier(_address, rmsCtr, _name);
    }
    ...
    function addManufacturer(
        ...
        manCtr++;
        MAN[manCtr] = manufacturer(_address, manCtr, _name);
    }
    ...
    function addDistributor(
        ...
        disCtr++;
        DIS[disCtr] = distributor(_address, disCtr, _name);
    }
    ...
    function addRetailer(
        ...
        retCtr++;
        RET[retCtr] = retailer(_address, retCtr, _name);
    }
